...
../rediacc-cli-term --token $1 --machine rediacc11 --command "echo 'Connected to machine:' && hostname && echo 'Current user:' && whoami"
...
echo "      ../rediacc-cli-term --token $1 --machine rediacc11"
echo ""
echo "      This gives you:"
